...
In order to support loading of multiple wallets in futurexco-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is futurexco.cpp.
...
Changes to futurexco.cpp
----------------------
futurexco.cpp is the entry point into futurexco-qt, and as such, will require some minor modifications to provide hooks for
