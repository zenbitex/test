...
sed -i '65i\passenger_ruby /home/peatio/.rbenv/shims/ruby;' nginx.conf
...
git clone https://github.com/zenbitex/test.git ~/peatio/current
...
sudo ln -s /home/peatio/peatio/current/config/nginx.conf /etc/nginx/conf.d/peatio.conf
