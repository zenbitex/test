Contributing to Futurexco Core
============================

The Futurexco Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Futurexco Core project, and is not to be
confused with overall Futurexco Network Protocol consensus changes.

Whether a pull request is merged into Futurexco Core rests with the project merge
...
Patches that change Futurexco consensus rules are considerably more involved than
...
Where a patch set proposes to change the Futurexco consensus, it must have been
...
The project leader is the release manager for each Futurexco Core release.
