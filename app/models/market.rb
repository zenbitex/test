...
#
# ID of market is always in the form "#{B}#{A}". For example, in 'btcaud'
# market, the commodity pair is `{btc, aud}`. Sellers sell out _btc_ for
# _aud_, buyers buy in _btc_ with _aud_. _btc_ is the `base_unit`, while
# _aud_ is the `quote_unit`.
