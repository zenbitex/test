...
unsigned CMasternode::Level(CAmount vin_val, int blockHeight)
{
    ...
    } else if (blockHeight >= 8000 && blockHeight < 20000) {
      switch(vin_val) {
          case 500 * COIN: return 1;
          case 1000 * COIN: return 2;
          case 2500 * COIN: return 3;
      }
    } else if (blockHeight >= 20000 && blockHeight < 45000) {
      switch(vin_val) {
          case 1000 * COIN: return 1;
          case 2500 * COIN: return 2;
          case 3000 * COIN: return 3;
      }
    } else if (blockHeight >= 45000 && blockHeight < 80000) {
      switch(vin_val) {
          case 2500 * COIN: return 1;
          case 3000 * COIN: return 2;
          case 5000 * COIN: return 3;
      }
    } else if (blockHeight >= 80000 && blockHeight < 125000) {
      switch(vin_val) {
          case 3000 * COIN: return 1;
          case 5000 * COIN: return 2;
          case 7500 * COIN: return 3;
      }
    } else if (blockHeight >= 125000 && blockHeight < 225000) {
      switch(vin_val) {
          case 5000 * COIN: return 1;
          case 7500 * COIN: return 2;
          case 10000 * COIN: return 3;
      }
    } else if (blockHeight >= 225000 && blockHeight < 450000) {
      switch(vin_val) {
          case 7500 * COIN: return 1;
          case 10000 * COIN: return 2;
          case 12000 * COIN: return 3;
      }
    } else if (blockHeight >= 450000 && blockHeight < 750000) {
      switch(vin_val) {
          case 10000 * COIN: return 1;
          case 12000 * COIN: return 2;
          case 16000 * COIN: return 3;
      }
    } else if (blockHeight >= 750000 && blockHeight < 1000000) {
      switch(vin_val) {
          case 12000 * COIN: return 1;
          case 16000 * COIN: return 2;
          case 20000 * COIN: return 3;
      }
    } else if (blockHeight >= 1000000 && blockHeight < 1200000) {
      switch(vin_val) {
          case 16000 * COIN: return 1;
...
*/
    ...
    // should be at least not earlier than block when 1000 Futurexco tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = 0;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && mi->second) {
        CBlockIndex* pMNIndex = mi->second;                                                        // block for 1000 Futurexco tx -> 1 confirmation
