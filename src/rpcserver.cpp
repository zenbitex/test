...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Futurexco server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Futurexco server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Futurexco features */
        {"futurexco", "masternode", &masternode, true, true, false},
        {"futurexco", "listmasternodes", &listmasternodes, true, true, false},
        {"futurexco", "getmasternodecount", &getmasternodecount, true, true, false},
        {"futurexco", "masternodeconnect", &masternodeconnect, true, true, false},
        {"futurexco", "masternodecurrent", &masternodecurrent, true, true, false},
        {"futurexco", "masternodedebug", &masternodedebug, true, true, false},
        {"futurexco", "startmasternode", &startmasternode, true, true, false},
        {"futurexco", "createmasternodekey", &createmasternodekey, true, true, false},
        {"futurexco", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"futurexco", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"futurexco", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"futurexco", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"futurexco", "getmasternodescores", &getmasternodescores, true, true, false},
        {"futurexco", "mnsync", &mnsync, true, true, false},
        {"futurexco", "spork", &spork, true, true, false},
        {"futurexco", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"futurexco", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use futurexcod, or the -server option to futurexco-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> futurexco-cli " + methodname + " " + args + "\n";
}
