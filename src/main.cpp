...
#if defined(NDEBUG)
#error "Futurexco cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ufuturexco) are considered zero fee (for relaying and mining)
...
CAmount GetBlockValue(int nHeight)
{
  // anti instamine
    ...
    if ( nHeight == 0 ) {    // premine
      ...
      nSubsidy = 0.1 * COIN;
    } else if (nHeight > 8000 && nHeight <= 20000) {
      nSubsidy = 2 * COIN;
    } else if (nHeight > 20000 && nHeight <= 45000) {
      nSubsidy = 4 * COIN;
    } else if (nHeight > 45000 && nHeight <= 80000) {
      nSubsidy = 12 * COIN;
    } else if (nHeight > 80000 && nHeight <= 125000) {
      nSubsidy = 36 * COIN;
    } else if (nHeight > 125000 && nHeight <= 225000) {
      nSubsidy = 100 * COIN;
    } else if (nHeight > 225000 && nHeight <= 450000) {
      nSubsidy = 300 * COIN;
    } else if (nHeight > 450000 && nHeight <= 750000) {
      nSubsidy = 150 * COIN;
    } else if (nHeight > 750000 && nHeight <= 1000000) {
      nSubsidy = 80 * COIN;
    } else if (nHeight > 1000000 && nHeight <= 1200000) {
      nSubsidy = 40 * COIN;
    } else if (nHeight > 1200000 && nHeight <= 3000000) {
      nSubsidy = 20 * COIN;
    } else {
      nSubsidy = 0.1 * COIN;
    }
...
{
    RenameThread("futurexco-scriptch");
