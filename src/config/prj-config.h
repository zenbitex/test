/* src/config/futurexco-config.h.  Generated from futurexco-config.h.in by configure.  */
/* src/config/futurexco-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Futurexco_CONFIG_H

#define Futurexco_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.futurexco.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Futurexco Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Futurexco Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "futurexco"
