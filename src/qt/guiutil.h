...
/** Utility functions used by the Futurexco Qt UI.
 */
namespace GUIUtil
{
...
// Render Futurexco addresses in monospace font
...
// Parse "futurexco:" URI into recipient object, return true on successful parsing
