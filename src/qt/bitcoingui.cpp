...
QFontDatabase::addApplicationFont(":/fonts/futurexco_font");

QString windowTitle = tr("Futurexco Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Futurexco address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Futurexco: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Futurexco Core"), this);
    aboutAction->setStatusTip(tr("Show information about Futurexco Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Futurexco"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Futurexco addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Futurexco addresses"));
    ...
    openAction->setStatusTip(tr("Open a Futurexco: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Futurexco Core help message to get a list with possible Futurexco command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Futurexco Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Futurexco network", "", count));
}
...
{
    QString strTitle = tr("Futurexco Core"); // default title
