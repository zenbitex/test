...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Futurexco Core"),
     ...
     * override -datadir in the futurexco.conf file in the default data directory
     * (to be consistent with futurexcod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
