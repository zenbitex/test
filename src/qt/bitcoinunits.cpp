...
// Copyright (c) 2017-2018 The FXC Core developers
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case FXC:
            return QString("FXC");
        case mFXC:
            return QString("Milli-FXC (1 / 1" THIN_SP_UTF8 "000)");
        case uFXC:
            return QString("Micro-FXC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case FXC:
            return QString("TestFXCs");
        case mFXC:
            return QString("Milli-TestFXCs (1 / 1" THIN_SP_UTF8 "000)");
        case uFXC:
            return QString("Micro-TestFXCs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
