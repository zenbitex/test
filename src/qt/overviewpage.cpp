...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::FXC)
    {
    }
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->label_Futurexco4->setVisible(showImmature || showWatchOnlyImmature);
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    if (model && model->getOptionsModel()) {
        ...
        connect(ui->blabel_Futurexco, SIGNAL(clicked()), this, SLOT(openMyAddresses()));

    }

    // update the display unit, to not use the default ("Futurexco")
    updateDisplayUnit();
}
...
void OverviewPage::updateMasternodeInfo()
{
  ...
  if (chainActive.Height() >= 0 && chainActive.Height() < 8000) {
    ui->label_lcolat->setText("250 Coins");
    ui->label_mcolat->setText("500 Coins");
    ui->label_fcolat->setText("1000 Coins");
  } else if (chainActive.Height() >= 8000 && chainActive.Height() < 20000) {
    ui->label_lcolat->setText("500 Coins");
    ui->label_mcolat->setText("1000 Coins");
    ui->label_fcolat->setText("2500 Coins");
  } else if (chainActive.Height() >= 20000 && chainActive.Height() < 45000) {
    ui->label_lcolat->setText("1000 Coins");
    ui->label_mcolat->setText("2500 Coins");
    ui->label_fcolat->setText("3000 Coins");
  } else if (chainActive.Height() >= 45000 && chainActive.Height() < 80000) {
    ui->label_lcolat->setText("2500 Coins");
    ui->label_mcolat->setText("3000 Coins");
    ui->label_fcolat->setText("5000 Coins");
  } else if (chainActive.Height() >= 80000 && chainActive.Height() < 125000) {
    ui->label_lcolat->setText("3000 Coins");
    ui->label_mcolat->setText("5000 Coins");
    ui->label_fcolat->setText("7500 Coins");
  } else if (chainActive.Height() >= 125000 && chainActive.Height() < 225000) {
    ui->label_lcolat->setText("5000 Coins");
    ui->label_mcolat->setText("7500 Coins");
    ui->label_fcolat->setText("10000 Coins");
  } else if (chainActive.Height() >= 225000 && chainActive.Height() < 450000) {
    ui->label_lcolat->setText("7500 Coins");
    ui->label_mcolat->setText("10000 Coins");
    ui->label_fcolat->setText("12000 Coins");
  } else if (chainActive.Height() >= 450000 && chainActive.Height() < 750000) {
    ui->label_lcolat->setText("10000 Coins");
    ui->label_mcolat->setText("12000 Coins");
    ui->label_fcolat->setText("16000 Coins");
  } else if (chainActive.Height() >= 750000 && chainActive.Height() < 1000000) {
    ui->label_lcolat->setText("12000 Coins");
    ui->label_mcolat->setText("16000 Coins");
    ui->label_fcolat->setText("20000 Coins");
  } else if (chainActive.Height() >= 1000000 && chainActive.Height() < 1200000) {
    ui->label_lcolat->setText("16000 Coins");
    ...
    ui->label_fcolat->setText("40000 Coins");
  }
...
double BlockRewardFuturexco =  static_cast<double>(BlockReward/COIN);
//int64_t FuturexcoSupply = chainActive.Tip()->nMoneySupply / COIN;
...
ui->label_CurrentBlockReward_value->setText(QString::number(BlockRewardFuturexco));
//ui->label_FuturexcoSupply_value->setText(QString::number(FuturexcoSupply));
