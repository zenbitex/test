...
// Wallet
    ...
    if (settings.contains("nAnonymizePrjAmount"))
        SoftSetArg("-anonymizefuturexcoamount", settings.value("nAnonymizePrjAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in futurexco.cpp during shotdown to also remove the window positions
