 ...
 * Futurexco system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& FuturexcoDevKey() const { return vFuturexcoDevKey; }
    // const std::vector<unsigned char>& FuturexcoFundKey() const { return vFuturexcoFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vFuturexcoDevKey;
    // std::vector<unsigned char> vFuturexcoFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
