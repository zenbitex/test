...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04ffff001d01043a446f6e277420776f726b20666f72207765656b656e64732c20776f726b20666f72206f757220676f616c73202d2032342f4465632f323031382e");
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 30;  // Futurexco: 0.5 minute after 750K
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Don't work for weekends, work for our goals - 24/Dec/2018.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049a001010da79684a0544c2254eb6c896fae95a9ea7b51d889475eb57ab2051f1a5858cac61ae400e90ea08015263ad40c65d36f0edf19e996972e7d2cbd13c15") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1545620580;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3660160;



        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("000000dbcb4d1ee0ae8fd8ec727bad328c243291b787a9c972e0d8d69e11302c"));
        assert(genesis.hashMerkleRoot == uint256("9bca362d80abc01b86f19c72027b9a98b9f2a7bd5a0c9a430662ae7bf6040d28"));

        vSeeds.push_back(CDNSSeedData("seed1.futurexco.com", "seed1.futurexco.com"));     // Primary DNS Seeder
        vSeeds.push_back(CDNSSeedData("seed2.futurexco.com", "seed2.futurexco.com"));     // Primary DNS Seeder
        vSeeds.push_back(CDNSSeedData("seed3.futurexco.com", "seed3.futurexco.com"));     // Primary DNS Seeder

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 35); // P
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 18);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 95); // p
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // Futurexco: 1 minute
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("futurexco.net", "seed01.futurexco.net"));     // Primary DNS Seeder
        ...
        // Testnet Futurexco BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Futurexco BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Futurexco BIP44 coin type is '1' (All coin's testnet default)
