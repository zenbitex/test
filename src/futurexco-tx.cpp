...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Futurexco Core futurexco-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  futurexco-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Futurexco transaction") + "\n" +
                               "  futurexco-tx [options] -create [commands]   " + _("Create hex-encoded Futurexco transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Futurexco transaction
