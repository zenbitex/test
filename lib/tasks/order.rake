namespace :order do
  task mock: :environment do
    ...
    market = Market.find 'ethaud'
    market = Market.find 'btcaud'
    market = Market.find 'bccaud'
    market = Market.find 'etcaud'
    market = Market.find 'zecaud'
    market = Market.find 'ltcaud'
    market = Market.find 'btsaud'
