...
#   c) node1 mines 32 blocks, so now node 0 has 60001futurexco, node 1 has 4250futurexco, node2 has none.
#   d) node0 sends 601 futurexco to node2, in two transactions (301 futurexco, then 300 futurexco).
